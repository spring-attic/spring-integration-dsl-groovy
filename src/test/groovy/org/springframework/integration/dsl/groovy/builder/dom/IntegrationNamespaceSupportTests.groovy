 ...
 *
 */
class IntegrationNamespaceSupportTests {
	def namespaceSupport = new IntegrationNamespaceSupport()
	...
	void testAddIntegrationNamespace() {
		...
		assert namespaceSupport.schemaLocations != IntegrationNamespaceSupport.REQUIRED_NAMESPACE_DECLARATIONS
